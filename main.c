...
int main(void)
{
	...
	ListaTravaPeca *listaPecasTravadas = NULL;
	ListaMovimentosOtimizados *listaMovimentosOtimizados = NULL;
	/*
	...
	*/
	...
	melhorCaminho(matriz, &listaEstado, &listaEstadosDefinitivos, &listaPecasTravadas);
...
printf("tamanho listaMovimentosOtimizados: %d\n", tamanhoListaDirecao(listaMovimentosOtimizados));
_getch();
